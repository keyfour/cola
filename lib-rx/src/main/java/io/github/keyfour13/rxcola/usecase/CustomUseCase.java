 ...
 */
public class CustomUseCase<T> extends UseCase<T> {

    private final Observable<T> observable;

    public CustomUseCase(ThreadExecutor threadExecutor, ThreadExecutor postExecutionThread,
                         Params<Observable<T>> params, Observable<T> observable) {
